...
export default function QuizPopup({ open, onQuizClose }) {
    const questions = useMemo(
        () => [
            ...
            {
                id: 3,
                question: "What is the first thing we ever watched together?",
                options: ["Lego Batman", "The Button", "Parks and Rec", "Friends"],
                correctAnswerIndex: 1,
            },
            {
                id: 4,
                question: "Pick one:",
                options: ["mmmmmmmmmmoopy", "moopyyyyyyyyyy", "moooooooopy", "moop"],
                correctAnswerIndex: 3,
            },
            {
                id: 5,
                question: "What did we order at Gao Xiao Pa",
                options: ["Rou Jia Mo", "Pork Skewers", "Truffle Soup Dumpling", "Jian Bing"],
